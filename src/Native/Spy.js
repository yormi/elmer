var _yormi$elmer$Native_Spy = function() {
  ...
  var create = function(name, fun) {
    ...
    if (!functionToSpyOn) {
      return _yormi$elmer$Elmer_Spy_Internal$Error({ name: name, calls: [] });
    }
  ...
  var deactivate = function (spyValue) {
    ...
    return _yormi$elmer$Elmer_Spy_Internal$Inactive(spyValue)
  }
  ...
  var activate = function(spyValue) {
    ...
    return _yormi$elmer$Elmer_Spy_Internal$Active(spyValueCopy)
  }
  ...
  var recordCall = function(spyValue, functionArguments) {
    ...
    for (var p in functionArguments) {
      ...
      switch (typeof arg) {
        case "string":
          argValue = _yormi$elmer$Elmer_Spy_Internal$StringArg(arg)
          break

        case "number":
          if (Number.isInteger(arg)) {
            argValue = _yormi$elmer$Elmer_Spy_Internal$IntArg(arg)
          } else {
            argValue = _yormi$elmer$Elmer_Spy_Internal$FloatArg(arg)
          }
          break

        case "boolean":
          argValue = _yormi$elmer$Elmer_Spy_Internal$BoolArg(arg)
          break

        case "object":
          argValue = _yormi$elmer$Elmer_Spy_Internal$TypedArg(_elm_lang$core$Native_Utils.toString(arg))
          break

        case "function":
          argValue = _yormi$elmer$Elmer_Spy_Internal$FunctionArg
          break
      }
  ...
  var registerFake = function(spyValue, fakeFun) {
    ...
    return _yormi$elmer$Elmer_Spy_Internal$Active(spyValue);
  }
  ...
  var calls = function(spyValue) {
    ...
    var spyCalls = (A2)(_yormi$elmer$Elmer_Spy_Internal$Calls,
      spyValue.name,
